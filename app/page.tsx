      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 py-12 sm:py-16">
        ...
        {result && cfg && (
          <div ref={resultRef}>
            ...
            {simulateMode && (result.risk as string) !== "Safe" && (
            ...
            {(result.risk as string) !== "Safe" && result.rewrite && (
              <div className="mb-4">
            ...
            {result && (result.risk as string) !== "Safe" && (
            ...
            {result && (result.risk as string) !== "Safe" && (result.pressure || getPressureWarning(result)) && (
